...
describe("transactionHash", () => {
  ...
  it("should return different hashes for different company ids", () => {
    const accountNumber = "123";
    const hash1 = transactionHash(transaction1, "leumi", accountNumber);

    const hash2 = transactionHash(transaction1, "isracard", accountNumber);
  ...
  it("Issue #132: hash has no nullish string", () => {
    ...
    for (const transaction of [transactionWithNull, transactionWithUndefined]) {
      const hash = transactionHash(transaction as any, "leumi", "123");
  ...
  describe("error handling for malformed transactions", () => {
    it("should throw error when transaction has null date", () => {
      ...
      expect(() => {
        transactionHash(transactionWithNullDate as any, "hapoalim", "123");
      }).toThrow();
    });
    ...
    it("should throw error when transaction has undefined date", () => {
      ...
      expect(() => {
        transactionHash(transactionWithUndefinedDate as any, "hapoalim", "123");
      }).toThrow();
    });
    ...
    it("should throw error when transaction has invalid date string", () => {
      ...
      expect(() => {
        transactionHash(transactionWithInvalidDate as any, "hapoalim", "123");
      }).toThrow();
    });
  });
});
...
describe("transactionUniqueId", () => {
  ...
  it("should return different unique ids for different company ids", () => {
    const accountNumber = "123";
    const id1 = transactionUniqueId(transaction1, "leumi", accountNumber);

    const id2 = transactionUniqueId(transaction1, "isracard", accountNumber);
  ...
  it.each([undefined, null, ""])(
    ...
    (identifier) => {
      ...
      const id = transactionUniqueId(tx as Transaction, "hapoalim", "123");
