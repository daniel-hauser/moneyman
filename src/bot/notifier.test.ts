...
import { escapeMessageForMarkdownV2 } from "./notifier.js";

describe("MarkdownV2 Escaping", () => {
  describe("escapers.MarkdownV2", () => {
    it("should escape special characters", () => {
      const text = "4 transactions scraped.";
      const escaped = escapers.MarkdownV2(text);
