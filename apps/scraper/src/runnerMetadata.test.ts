...
describe("runnerMetadata", () => {
  ...
  describe("getExternalIp", () => {
    it("should return 'disabled' when getIpInfoUrl is false", async () => {
      ...
      process.env = {
        ...originalEnv,
        MONEYMAN_SCRAPER_CONFIG: JSON.stringify(configWithDisabledIp),
      };
    ...
    it("should fetch from URL when getIpInfoUrl is a valid URL", async () => {
      ...
      process.env = {
        ...originalEnv,
        MONEYMAN_SCRAPER_CONFIG: JSON.stringify(configWithCustomUrl),
      };
    ...
    it("should return 'unknown' when fetch fails", async () => {
      ...
      process.env = {
        ...originalEnv,
        MONEYMAN_SCRAPER_CONFIG: JSON.stringify(configWithUrl),
      };
    ...
    it("should use default URL when getIpInfoUrl is not specified", async () => {
      ...
      process.env = {
        ...originalEnv,
        MONEYMAN_SCRAPER_CONFIG: JSON.stringify(configWithDefaults),
      };
