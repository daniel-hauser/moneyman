...
import type { TransactionRow } from "@moneyman/protocol";
import {
  TransactionStatuses,
  TransactionTypes,
...
import {
  ...
  skippedString,
  type SaveStats,
} from "../../exporter/src/saveStats.js";
import { saving } from "../../exporter/src/messages.js";
import { Timer } from "@moneyman/common";
import { transaction as protocolTransaction } from "@moneyman/protocol/testing";

const transaction = (overrides: Partial<Transaction>): Transaction =>
  protocolTransaction(overrides) as unknown as Transaction;
