...
| `RAW_TRANSACTION_DATA_ENABLED`        | `'true'`           | If set to `'true'` (default), includes the raw TransactionRow JSON data in a `raw` column in Google Sheets. Set to `'false'` to disable this feature.                     |
