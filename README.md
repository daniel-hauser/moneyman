...
| `RAW_TRANSACTION_DATA_DISABLED`       | `'false'`          | If set to `'true'`, disables the raw TransactionRow JSON data column in Google Sheets. By default (`'false'`), the raw column is included.                                   |
